...
<xsl:template match="/">
	<html xml:lang="fr">
		<head>
			...
			<meta name="keywords" content="johan, cwiklinski, curriculum vitae, réalisation de sites web, programmation, webmaster, webmestre, java, php, linux, redhat, réseau, lan, securite, logiciels open, source, programmation, trasher"/>
		...
		<body>
			<div id="content">
				...
				<ul id="styleswitcher">
					...
					<li><a href="?css=blue">blue</a></li>
					<li><a href="?css=black">black</a></li>
					<li><a href="?css=nostyle">no style</a></li>
				</ul>
				<xsl:call-template name="summary"/>
				<xsl:apply-templates/>
				<!--<xsl:apply-templates select="//presentation" />
				<xsl:apply-templates select="descriptif" />-->
				<xsl:call-template name="w3"/>
			</div>
		</body>
	</html>
</xsl:template>
...
<xsl:template name="w3">
	<div id="w3c">
		...
		<ul>
			...
			<li>
				<a href="http://jigsaw.w3.org/css-validator/validator?check=referer" title="Validation CSS 2.0">
